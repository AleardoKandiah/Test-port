...
function BackgroundCircles({}: Props) {
  return (
    ...
    className='relative flex justify-center items-center'>
        <div className='absolute rounded-full border border-[#333333] h-[200px] w-[200px] mt-52
        animate-ping'/>
        ...
        animate-ping'/>   
        <div className=' absolute rounded-full border opacity-20 border-[#F7AB0A] h-[650px] w-[650px] mt-52
